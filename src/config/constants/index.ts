...
const arrayPackage5G = [
  ...
  {
    code: 'Miễn phí data truy cập Facebook, YouTube, cho thuê bao trưởng nhóm. Quyền lợi Clip TV K+"',
    price: 0,
    cycle: "Dài kỳ",
    revenueOld: "",
    revenue: "",
  ...
  },
  {
    ...
    " sms ": "0",
    " inAudio  ":
      "Miễn phí các cuộc gọi nội mạng dưới 10 phút; ngoại mạng 80 phút",
    " outAudio ": "",
    data: "2GB/ngày",
    cvgt: "0",
    permission:
